...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xiawenbin/LXMediator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xiawenbin' => 'xiawenbin@5eplay.com' }
  s.source           = { :git => 'https://github.com/xiawenbin/LXMediator.git', :tag => s.version.to_s }
